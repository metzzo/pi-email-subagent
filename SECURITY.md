...
- Pi 0.81.1 exposes no automatic process-quiescence receipt or release for an unknown process-capable cleanup quarantine. Waiting, abort/dispose deadlines, and an empty active-tool map are not containment proof.
