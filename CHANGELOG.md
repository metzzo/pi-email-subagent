...
- Cross-platform namespace diagnostics now report an existing PID from incomplete owner metadata only as a fail-closed contender block, never as exact-owner identity or reclaim authority; absent or unknown incomplete owners remain unreclaimable.
