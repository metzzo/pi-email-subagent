...
- Missing, stale, or dead namespace owner sidecars/lock directories now remain fail-closed orphans. Automatic abandoned-owner takeover is disabled because Pi 0.81.1 cannot atomically bind lock acquisition to owner publication; manual recovery is permitted only after local-host/PID-namespace quiescence is independently verified.
