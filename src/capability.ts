...
export function isConfiguredWritable(
  tools: readonly string[],
  declaredEffects: Readonly<Record<string, "read" | "write">> = {},
): boolean {
  return tools.some((tool) => !KNOWN_NON_MUTATING_TOOLS.has(tool) && declaredEffects[tool] !== "read");
}
